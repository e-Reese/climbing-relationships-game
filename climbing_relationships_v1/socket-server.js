    ...
    if (playerIndex === game.currentPlayerIndex) {
      ...
      if (playerIndex === 0) {
        ...
        game.climber1Position = {
          ...
          y: Math.max(10, game.climber1Position.y - moveAmount)
        };
        ...
        game.climber2Position = {
          ...
          y: Math.max(10, game.climber2Position.y - moveAmount)
        };
      ...
      console.log('Emitting turn-result with climber positions:', JSON.stringify({
        climber1Pos: resultData.climber1Pos,
        climber2Pos: resultData.climber2Pos
      }));
      
      // Emit result to all players in the game
      io.to(gameId).emit('turn-result', resultData);
